...
<p>
  <strong>Build piano with React and Recoil</strong>
  <br /><br />
  <strong>基于 React 和 Recoil 构建钢琴应用</strong>
</p>


<p>
  <sub>Made with ❤︎ by
    <a href="https://github.com/yinguangyao">Yin Guangyao</a>
  </sub>
</p>
</div>
...
> 体验地址： http://piano.gyyin.top


> 项目地址： https://github.com/yinguangyao/react-piano
...
本项目参考自 eno yao 的 omi piano，重新用 React 实现了一遍，增加了歌曲。
...
```bash
# 获取远程仓库代码
git clone https://github.com/yinguangyao/react-piano
# 进入目录
cd react-piano
# 安装依赖
yarn
...
使用 Vite 作为构建工具，前端使用 React，状态管理没有用 Redux 和 Mobx，而是使用 Recoil 来实现。
